...
class Markdown {
    ...
    static var instance:Markdown = new Markdown();
  ...
  function new () {
    ...
    public static function run(str:String) : String {
        return instance.makeHtml(str);
    }
  ...
  function doCodeBlocks_cb(re: EReg): String {
    ...
    codeblock = encodeCode( outdent(codeblock, true));
  ...
  function outdent (text:String, firstTabOnly=false) {
  //
  ...
  if (firstTabOnly){
    ...
    text = replaceText(text,~/^(\t|[ ]{1,4})/mg,"~0"); // attacklab: g_tab_width
